...
public class F1BritainScene extends BaseScene {
    private static F1BritainController controller;
    ...
    public static F1BritainScene init(Stage stage, SceneId sceneId, RaceGroups group, String raceName) throws IOException {
        // LOAD SCENE
