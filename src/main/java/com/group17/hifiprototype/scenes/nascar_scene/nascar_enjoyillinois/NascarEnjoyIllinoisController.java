...
public class NascarEnjoyIllinoisController extends BaseMotorsportController {
    ...
    public void loadWeatherData(){
         ...
         */
        try {
            Race currentRace = RaceLoader.getGroup(RaceGroups.F1).getRace("Enjoy Illinois 300");
