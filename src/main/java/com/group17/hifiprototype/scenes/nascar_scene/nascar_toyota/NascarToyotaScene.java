...
public class NascarToyotaScene extends BaseScene {
    private static NascarToyotaController controller;

    private NascarToyotaScene(){}
    ...
    public static NascarToyotaScene init(Stage stage, SceneId sceneId, RaceGroups group, String raceName) throws IOException {
        // LOAD SCENE

        //TODO: CHANGE SCENE
        FXMLLoader fxmlLoader = new FXMLLoader(MainApplication.class.getResource("nascar_toyota.fxml"));
        Parent root = fxmlLoader.load();
        Scene scene = new Scene(root);

        // CREATE SCENE
        NascarToyotaScene returnedScene = new NascarToyotaScene();
